    ...
    <div className="container mx-auto">
      ...
      >
        <div className="hero-gradient px-5 md:px-12 py-6 md:py-8">
          ...
          <h3 className="text-xl md:text-3xl font-extrabold text-primary-foreground">SAVE&SAFE â€“ Innovation in der Versorgung</h3>
        </div>

        <div className="p-5 md:p-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-8 mb-8 md:mb-10">
            {[
              { icon: HeartPulse, title: "Versorgungsproblem", text: "SAVE&SAFE adressiert ein konkretes Versorgungsproblem, bei dem bestehende Strukturen an ihre Grenzen stoÃŸen und innovative AnsÃ¤tze erforderlich sind." },
              { icon: Shield, title: "LÃ¶sungsansatz", text: "Das Projekt kombiniert technologische Innovation mit einem Versorgungsmodell, das auf Evidenz und ErstattungsfÃ¤higkeit ausgerichtet ist." },
              { icon: Users, title: "Go-To-Market", text: "Die LÃ¶sung adressiert einen relevanten Markt im deutschen Gesundheitswesen mit klarem Skalierungspotenzial und Nutzen fÃ¼r alle Beteiligten bis hin zum Markteintritt." },
            ].map((item) => (
          ...
          <div className="bg-muted/50 rounded-xl p-4 md:p-6 mb-6 md:mb-8 border border-border/50 flex flex-col sm:flex-row items-center gap-4 md:gap-6">
            ...
            <p className="text-xs md:text-sm text-muted-foreground italic text-center sm:text-left">
              KI-basierte LÃ¶sungen, um StÃ¼rze zu vermeiden und PflegekrÃ¤fte zu entlasten. Gemeinsam arbeiten wir an einer sicheren Zukunft in der Geriatrie.
            </p>
          </div>
